...
function ResturentInformation() {
  return (
    ...
    <div className="" style={{ width: "60%", textAlign: "center" }}>
              ...
              <TextField id="outlined-basic" label="Contact Number" required variant="outlined" style={{ width: "100%", marginTop: "10px" }} />
              <TextField id="outlined-basic" label="Email" required variant="outlined" style={{ width: "100%", marginTop: "10px" }} />
              <TextField id="outlined-basic" label="BIN Number" required variant="outlined" style={{ width: "100%", marginTop: "10px" }} />
              <TextField id="outlined-basic" label="Branch Name" required variant="outlined" style={{ width: "100%", marginTop: "10px" }} />
              ...
              <TextField id="outlined-basic" label="Branch Manager Email" required variant="outlined" style={{ width: "100%" }} />
