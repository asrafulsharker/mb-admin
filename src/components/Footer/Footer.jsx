    ...
    <Container>
        <div className="" style={{display:'flex',flexWrap:"wrap",justifyContent:"space-between",alignItems:"center"}}>
            ...
            <div className="" style={{display:"flex",justifyContent:"center",alignItems:"center",gap:"16px"}}>
                ...
                <a href=""><img src="../../../public/images/icons/Facebook_f_logo_(2021) 1.svg" alt="" /></a>
                <a href=""><img src="../../../public/images/icons/Instagram_logo_2016 1.svg" alt="" /></a>
                <a href=""><img src="../../../public/images/icons/LinkedIn_icon 1.svg" alt="" /></a>
            </div>
        </div>
    </Container>
    </div>
